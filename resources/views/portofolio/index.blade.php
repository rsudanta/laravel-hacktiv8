            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-5 mt-4 mt-lg-0 align-content-center">
                    <div class="row">
                        ...
                        <div class="col-lg-8" id="data-' . $field . '">Full Time</div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4"><b>Age</b></div>
                        <div class="col-lg-8" id="data-' . $field . '">24 years</div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4"><b>Location</b></div>
                        <div class="col-lg-8" id="data-' . $field . '">Jakarta</div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4"><b>Years of Experience</b></div>
                        <div class="col-lg-8" id="data-' . $field . '">2 years</div>
                    </div>
                    <div class="row">
                        <div class="col-lg-4"><b>Email</b></div>
                        <div class="col-lg-8" id="data-' . $field . '">rsudanta20@gmail.com</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card px-4 py-4 mt-4 container">
            <form method="POST" action="proses.php?perintah=create">
                ...
                <div class="mb-3">
                    ...
                    <small class="number-warning form-text text-danger" style="display: none;">Age must be type of an
                        integer and must be postive.</small>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <small class="number-warning form-text text-danger" style="display: none;">Years of Experience
                        must be type of an integer and must be postive.</small>
